...
let ellisIsland, ellisIslandMarker;
  ...
  ellisIslandMarker = L.marker(ellisIsland).addTo(firstMap).bindPopup("ELLIS ISLAND"+'<img src="https://i.imgur.com/ZUzKAwz.png" width="300" height="250"/>'+"African American immigration to the United States was arduous and much unlike the experience of Ellis Island immigrants.  "+'<a href="https://en.wikipedia.org/wiki/African_immigration_to_the_United_States">Read more about African American immigration here</a>');
let md;
